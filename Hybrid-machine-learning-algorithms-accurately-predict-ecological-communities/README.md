...
The application can be downloaded at [https://zenodo.org/record/7278042].

Use the link below to be redirected to the tutorial page.

iMESc_help [https://danilocvieira.github.io/iMESc_help/]

- Savepoint_DiversityIndex.rds
		Savepoint with diversity index datalist from the nematodes data.

- Savepoint_UnsupervisedML.rds
		Savepoint of the unsupervised steps of the hybrid model: Self-organizing map (SOM), and hierarchical cluster (HC).

- Savepoint_SupervisedML_MetaModel.rds
		Savepoint of the supervised steps of the hybrid model: Majority Weighted Voting Ensemble Model (MVWE), and meta-model.

- Savepoint_Environ_VCSand_VCSilt_VFSand.rds
		Savepoint of the models of the environmental variables Very Coarse Sand, Very Coarse Silt, and Very Fine Sand.
